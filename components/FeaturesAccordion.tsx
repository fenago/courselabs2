...
const features = [
  {
    title: "Instant Lab Prebuilds",
    description:
      "No more 10-minute waits. Labs are instantly ready when your students arrive, ensuring professional, seamless training sessions that enhance your reputation and student satisfaction.",
    type: "video",
