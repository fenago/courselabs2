@echo off
echo Running Git Push Script for CourseLabs
echo ==========================================

echo Setting remote repository to https://github.com/fenago/courselabs2...
git remote remove origin 2>nul
git remote add origin https://github.com/fenago/courselabs2.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/fenago/courselabs2
